...
<body>
    ...
    <div id="log_online_mooc" style="height: 100vh; position: relative;"
    ...
    <script>
        ...
        $(function () {
            ...
            $.getJSON("{{ url('/users/online') }}", function (data) {
                onlineusers('log_online_mooc', data.list.users);
            });
        });
    </script>
