    ...
    <script>
        ...
        $(function () {
            function sedapmalam(div, rs) {
                ...
                let foto = 'https://media-exp1.licdn.com/dms/image/C5603AQH8hOPmVvqLjw/profile-displayphoto-shrink_400_400/0/1638023558622?e=1646265600&v=beta&t=uGtJBNnOFtHPtiGtEVkwp17Jx2wsPwGaHvFzBfKD0Os';
                let nama = 'rizky dwi aditya';
                let lat = -7.2484;
                let lng = 112.7419;
                L.marker([lat, lng], { icon: icon_loc }).addTo(mymap).bindPopup('<div align=center><img style="border-radius: 50%; width:50px" src="' + foto + '"><br><strong>' + nama + '</strong></div>').openPopup();
